...
function Carrinho() {
  ...
  const payloadPix = gerarPayloadPix({ chave: chavePix, nome: nomeRecebedor, cidade, valor: totalFinal });
 
  /* ── INPUT VALOR PAGO ── */
  const handleValorPago = (e) => {
    const apenasNumeros = e.target.value.replace(/\D/g, "");
    if (!apenasNumeros) { setValorPago(""); setValorNumerico(0); return; }
          ...
          {pagamento === "pix" && (
            <div className="pix-box">
              ...
              <div className="pix-copy">
                ...
                <button onClick={() => { navigator.clipboard.writeText(payloadPix); alert("Código Pix copiado!"); }}>
                  Copiar código
                </button>
              </div>
